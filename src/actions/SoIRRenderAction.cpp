...
{
  // Custom legacy shader programs are not part of the backend-neutral IR.
  // Keep the node dispatch so scene traversal remains structurally complete;
  // SoShaderProgram::render(SoIRRenderAction *) intentionally ignores them.
